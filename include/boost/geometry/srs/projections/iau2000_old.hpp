...
#ifndef BOOST_GEOMETRY_PROJECTIONS_IAU2000_OLD_HPP
#define BOOST_GEOMETRY_PROJECTIONS_IAU2000_OLD_HPP


#include <boost/geometry/srs/projections/code_old.hpp>
...
namespace detail
{
    ...
    inline srs::dpar::parameters<> iau2000_to_parameters_old(int code)
    {
        using namespace srs::dpar;

        static const code_element_old arr[] = {
        ...
        const code_element_old * first = arr;
        const code_element_old * last = arr + sizeof(arr) / sizeof(code_element_old);
        const code_element_old * el = binary_find_code_element_old(first, last, code);
