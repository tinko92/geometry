...
#ifndef BOOST_GEOMETRY_PROJECTIONS_ESRI_OLD_HPP
#define BOOST_GEOMETRY_PROJECTIONS_ESRI_OLD_HPP
...
namespace detail
{
    ...
    inline srs::dpar::parameters<> esri_to_parameters_old(int code)
    {
