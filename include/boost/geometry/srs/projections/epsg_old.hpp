...
#ifndef BOOST_GEOMETRY_PROJECTIONS_EPGS_OLD_HPP
#define BOOST_GEOMETRY_PROJECTIONS_EPGS_OLD_HPP
...
namespace detail
{
    ...
    inline srs::dpar::parameters<> epsg_to_parameters_old(int code)
    {
