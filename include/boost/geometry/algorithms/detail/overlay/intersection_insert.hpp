...
struct intersection_of_linestring_with_areal
{
            ...
            Strategy const& strategy)
    {
        ...
        using point_type = typename point_type
            <
        ...
        dispatch::get_turns
            <
                ...
                turn_policy
            >::apply(0, linestring, 1, areal, strategy, turns, policy);
...
struct intersection_linear_areal_point
{
    ...
    static inline OutputIterator apply(Geometry1 const& geometry1,
                                       ...
                                       Strategy const& strategy)
    {
        using ratio_type = geometry::segment_ratio<typename geometry::coordinate_type<PointOut>::type>;
        ...
        dispatch::get_turns
            <
                ...
                false,
                turn_policy
            >::apply(0, geometry1, 1, geometry2, strategy, turns, interrupt_policy);
        ...
        bgt::get<out_point_index>(oits) = intersection_insert
            <
                ...
                typename bgt::element
                    ...
                    >::type,
                OverlayType
            >::apply(pointlike1, pointlike2, bgt::get<out_point_index>(oits), strategy);
