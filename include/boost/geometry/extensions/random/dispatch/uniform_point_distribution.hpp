...
namespace boost { namespace geometry { namespace random { namespace dispatch
{
    ...
    class uniform_point_distribution : public detail::uniform_point_distribution<Point, DomainGeometry, DomainSubset, DomainTag,
        MultiOrSingle,
        CSTag,
        dimension
    >
    {
    public:
        typedef detail::uniform_point_distribution<Point, DomainGeometry, DomainSubset, DomainTag, MultiOrSingle, CSTag, dimension> base;
        using base::base;
    };
