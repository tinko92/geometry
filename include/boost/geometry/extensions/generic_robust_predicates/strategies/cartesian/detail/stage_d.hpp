...
private:
    static constexpr std::size_t left_size =
        expansion_size_impl<typename Expression::left>::value;
    static constexpr std::size_t right_size =
        expansion_size_impl<typename Expression::right>::value;
public:
...
template <typename Expression> using expansion_size =
    boost::mp11::mp_size_t< expansion_size_impl<Expression>::value >;
