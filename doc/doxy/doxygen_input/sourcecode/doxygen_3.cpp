...
void example_length1()
{
    ...
    line.push_back(std::make_tuple(1, 2, 3));
    line.push_back(std::make_tuple(4, 5, 6));
    line.push_back(std::make_tuple(7, 8, 9));
...
void example_length2()
{
    ...
    line.push_back(std::make_tuple(1.1, 2.2));
    line.push_back(std::make_tuple(3.3, 4.4));
    line.push_back(std::make_tuple(5.5, 6.6));
...
void example_less()
{
    typedef std::tuple<double, double> P;
    std::vector<P> line;
    line.push_back(std::make_tuple(8.1, 1.9));
    line.push_back(std::make_tuple(4.2, 7.5));
    line.push_back(std::make_tuple(2.3, 3.6));
