...
// To test travels_to_vertex
static std::string case_multi_3[2] =
{
    "MULTIPOLYGON(((1 2,0 3,0 8,1 9,6 9,7 8,7 3,6 2,1 2)))",
    "MULTIPOLYGON(((4 1,4 3,2 4,6 5,2 6,6 7,4 8,4 10,10 10,10 1,4 1)))"
};
...
static std::string case_141_multi[2] =
{
    ...
    MULTIPOLYGON(
        ((0 0,0 10,10 10,10 0,0 0),
            (2 3,1 2,2 1,3 2,2 3),
            (2 7,3 8,2 9,1 8,2 7),
            (10 3,9 4,8 3,9 2,10 3),
            (7 10,6 9,7 8,8 9,7 10),
            (10 7,9 8,8 7,9 6,10 7)))
    )"""",
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,10 10,10 0,0 0),
            ...
            (3 2,4 1,5 2,4 3,3 2),
            (3 8,4 7,5 8,4 9,3 8),
            (7 2,8 1,9 2,8 2,8 3,7 2),
            (8 7,7 8,6 7,7 6,8 7)))
    )""""
};

static std::string case_142_multi[2] =
{
    // Simpler version of 141 with one isolated interior (in intersection),
    // no clusters, no self-turns. Only cc, ii and ui turns.
    R""""(
    MULTIPOLYGON(
    ...
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,4 10,5 11,6 10,10 10,10 0,0 0),
            (5 10,2 7,5 4,8 7,5 10))
        )
    )""""
};

static std::string case_143_multi[2] =
{
    // Same but with one extra inteior
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,10 10,10 8,10 6,10 4,10 2,10 0,0 0),
            (2 7,4 5,6 5,8 7,2 7),
            (5 4,4 3,5 2,6 3,5 4)
            )
        )
    ...
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,4 10,5 11,6 10,10 10,10 9,10 7,10 5,10 3,10 1,10 0,0 0),
            (5 10,2 7,5 4,8 7,5 10))
        )
    )""""
};

static std::string case_144_multi[2] =
{
    // Simple case resulting in two separate exterior rings.
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,10 10,10 0,0 0),
            (2 7,4 5,6 5,8 7,2 7),
    ...
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,4 10,5 11,6 10,10 10,10 9,10 1,10 0,6 0,5 -1,4 0,0 0),
            (5 10,2 7,5 4,8 7,5 10),
            (4 1,5 0,6 1,5 2,4 1)
            )
        )
...
static std::string case_145_multi[2] =
{
    // Simpler version of 141 with two isolated interiors, and two variations in the lower corners.
    // This gives mainly cc, some ii, and some iu cases.
    R""""(
    MULTIPOLYGON(
        ((0 2,0 9,0 10,2 10,6 10,10 10,10 4,10 0,7 0,2 0,0 2),
            (10 7,9 8,8 7,9 6,10 7),
            (3 8,5 6,7 8,3 8),
            (5 0,6 1,5 2,4 1,5 0))
        )
    ...
    R""""(
    MULTIPOLYGON(
        ((0 0,0 1,0 10,4 10,5 11,6 10,10 10,10 4,10 2,8 0,3 0,0 0),
            (5 10,3 8,5 6,7 8,5 10),
            (0 5,2 3,4 5,2 7))
        )
    )""""
};

static std::string case_146_multi[2] =
{
    // As 141, with an interior ring and a separate island,
    // but 1: attached is another isolated interior ring
    // and 2: these combined shapes are copied to the left, in reversed order.
    R""""(
    MULTIPOLYGON(
        ((0 0,0 10,10 10,10 0,0 0),
            (10 3,9 4,8 3,9 2,10 3),
    ...
    MULTIPOLYGON(
        ((0 0,0 10,10 10,10 0,0 0),
            (7 2,8 1,9 2,8 2,8 3,7 2),
            (2 2,3 1,4 2,3 2,3 3,2 2),
            (8 7,7 8,6 7,7 6,8 7))
        )
    )""""
};

static std::string case_147_multi[2] =
{
    // Version with touching islands in holes in various ways.
    R""""(
    MULTIPOLYGON(
        ((10 0,0 10,10 20,20 10,10 0),
            (5 5,7 5,7 7,5 7,5 5),
            (15 5,15 9,11 9,11 5,15 5),
            (5 15,5 11,7 11,6 12,7 13,7 15,5 15),
            (15 15,11 15,11 11,15 11,15 15)),
        ((15 9,14 6,11 5,12 8,15 9)),
        ((15 15,14 12,11 11,12 14,15 15))
        )
    )"""",
    R""""(
    MULTIPOLYGON(
        ((10 0,0 10,10 20,20 10,10 0),
            (7 7,9 7,9 9,7 9,7 7),
            (15 5,15 9,11 9,11 5,15 5),
            (7 15,8 14,7 13,7 11,9 11,9 15,7 15),
            (15 15,11 15,11 11,15 11,15 15)),
        ((15 9,14 6,11 5,12 8,15 9)),
        ((15 15,14 12,11 11,12 14,15 15)),
        ((7 9,8.5 8.5,9 7,7.5 7.5,7 9))
        )
    )""""
};

static std::string case_148_multi[2] =
{
    // For clustered self-turns
    R""""(
    MULTIPOLYGON(
        ((2 3,2 2,1 2,1 3,2 3)),
        ((2 0,0 0,0 2,1 2,1.5 1.5,2 2,2 1,1 1,2 0)),
        ((2 0,2 1,3 2,4 2,3.5 1.5,4 1,4 0,2 0),   (2 1,2.5 0.5,3 1,2 1))
        )
    )"""",
    R""""(
    MULTIPOLYGON(
        ((2 0,2 1.5,3.5 3,4 3,4 0,2 0)),
        ((1.0 0.5,1.0 3,1.5 3,1.5 0.5,1.0 0.5)),
        ((2 2,2 3,2.5 3,2.5 2,2 2))
        )
    )""""
};

static std::string case_149_multi[2] =
{
    // For all turn situations (cc, ii, uu, iu, ux, ix),
    // without self-intersections or clusters.
    R""""(
    MULTIPOLYGON(
        ((1 0,1 9,10 9,10 0,7 0,5 0,3 0,1 0),    (9 6,7 8,5 6,7 4,9 6),  (6 3,4 5,3 4,5 2,6 3) ),
        ((5 10,3 12,5 14,7 12,5 10))
        )
    )"""",
    R""""(
    MULTIPOLYGON(
        ((0 0,0 3,0 6,0 10,9 10,9 0,7 0,5 0,3 0,0 0),     
         (5 2,3 4,2 3,4 1,5 2),
         (1 7,3 5,5 7,3 9,1 7)
         ),
         ((7 12,5 14,7 16,9 14,7 12))
...
static std::string case_recursive_boxes_89[2] =
{
    "MULTIPOLYGON(((1 3,2 3,2 2,1 2,1 3)),((1 1,2 2,2 1,1 1)))",
    "MULTIPOLYGON(((1 0,1 3,3 3,3 2,2 2,3 1,2 1,1 0)))"
};

static std::string case_recursive_boxes_90[2] =
{
    "MULTIPOLYGON(((5 3,5 4,6 4,5 3)),((7 1,6 1,6 2,7 1)),((5 1,5 2,6 2,5 1)))",
    "MULTIPOLYGON(((7 1,4 1,5 2,5 3,6 3,6 2,7 2,7 1)),((4 3,5 2,4 2,4 3)),((7 5,6 4,6 5,7 5)))"
};

static std::string case_recursive_boxes_91[8] =
{
    // Issue which needs selection of cc by distance to next turn.
    // TODO: calculate it OVER THE RING.
    
    // Originals (problematic)
    "MULTIPOLYGON(((7 10,7 9,8 8,7 8,7 7,6 7,6 6,5 6,5 7,4 7,4 9,5 10,5 9,6 10,7 10)),((3 3,3 4,2 4,2 5,3 5,3 6,2 6,2 7,4 7,4 6,5 6,4.5 5.5,5 5,5 4,4 4,4 3,3 3)),((6 4,6 3,5 3,6 4)),((4 3,5 4,5 3,4 3)),((3 1,4 0,3 0,3 1)),((5 2,5 0,4 0,4 1,5 2)),((2 4,0 4,0 5,1 5,2 4)),((0 1,0 3,1 4,1 3,2 3,3 2,4 2,4 1,0 1),(1 1,1 2,0.5 1.5,1 1)),((2 8,2 9,3 10,4 10,4 9,3 8,2 8)),((0 6,1 7,0 7,1 8,2 8,2 7,1 6,0 6)),((4 8,3 7,3 8,4 8)),((7 7,7 5,6 5,6 6,7 7)),((7 2,7 3,8 4,7 4,7 5,9 5,9 4,10 4,10 3,8 3,8 2,7 2)),((10 0,6 0,6 1,8 1,8 2,9 2,9 1,10 0)),((7 9,8 10,8.5 9.5,9 10,10 10,10 7,9 7,9 8,8 8,9 9,7 9)),((2 4,3 3,2 3,2 4)),((6 1,6 3,7 2,6 1)),((1 10,2 9,1 9,1 10)),((6 3,7 4,7 3,6 3)),((10 2,10 1,9 1,10 2)),((8 8,9 7,8 7,8 8)))",
    "MULTIPOLYGON(((10 3,10 1,9 1,9 2,8 2,8 1,7 1,7 0,6 0,6 1,5 1,5 0,3 0,5 2,5 3,6 3,7 2,8 3,10 3)),((7 4,6 4,6 5,5 4,4 4,5 5,5 6,4 6,4 8,5 9,4 9,4 10,6 10,8 8,8 7,7 7,7 8,5 8,5 7,6 7,6 6,7 5,7 4),(6 9,6 10,5.5 9.5,6 9)),((3 4,3 6,3.5 5.5,4 6,4 4,3 4)),((6 8,7 7,6 7,6 8)),((3 1,4 2,4 1,3 1)),((0 3,0 5,1 6,1 5,2 6,2 5,3 5,2 4,1 4,1 3,0 3)),((4 2,3 2,3 0,2 0,2 1,0 1,1 2,2 2,2 3,3 3,4 2)),((1 1,1 0,0 0,0 1,0.5 0.5,1 1)),((0 8,0 9,1 10,3 10,2 9,1 9,1 8,0 8)),((0 6,0 7,1 7,2 8,1 8,2 9,3 8,4 8,3 7,2 7,2 6,0 6)),((10 6,10 4,8 4,8 5,9 5,10 6)),((9 8,9 9,10 10,10 9,9 8)),((9 10,9 9,7 9,7 10,8 10,8.5 9.5,9 10)),((10 0,9 0,9 1,9.5 0.5,10 1,10 0)),((6 4,5 3,5 4,6 4)),((4 4,5 3,4 3,4 4)),((3 6,3 7,4 7,3 6)),((8 6,7 6,7 7,8 6)))",
    
    // Rewritten by PostGIS intersection (OK)
    "MULTIPOLYGON(((7 9,8 8,7 8,7 7,6 7,6 6,5 6,5 7,4 7,4 8,4 9,5 10,5 9,6 10,7 10,7 9)),((3 4,2 4,2 5,3 5,3 6,2 6,2 7,3 7,4 7,4 6,5 6,4.5 5.5,5 5,5 4,4 4,4 3,3 3,3 4)),((6 3,5 3,6 4,6 3)),((5 4,5 3,4 3,5 4)),((4 0,3 0,3 1,4 0)),((5 0,4 0,4 1,5 2,5 0)),((1 4,0 4,0 5,1 5,2 4,1 4)),((0 3,1 4,1 3,2 3,3 2,4 2,4 1,3 1,1 1,0 1,0 3),(1 2,0.5 1.5,1 1,1 2)),((2 9,3 10,4 10,4 9,3 8,2 8,2 9)),((1 7,0 7,1 8,2 8,2 7,1 6,0 6,1 7)),((3 7,3 8,4 8,3 7)),((7 5,6 5,6 6,7 7,7 5)),((7 3,8 4,7 4,7 5,9 5,9 4,10 4,10 3,8 3,8 2,7 2,7 3)),((6 0,6 1,8 1,8 2,9 2,9 1,10 0,6 0)),((8 10,8.5 9.5,9 10,10 10,10 7,9 7,9 8,8 8,9 9,7 9,8 10)),((3 3,2 3,2 4,3 3)),((6 3,7 2,6 1,6 3)),((2 9,1 9,1 10,2 9)),((7 4,7 3,6 3,7 4)),((10 1,9 1,10 2,10 1)),((9 7,8 7,8 8,9 7)))",
    "MULTIPOLYGON(((10 1,9 1,9 2,8 2,8 1,7 1,7 0,6 0,6 1,5 1,5 0,3 0,4 1,5 2,5 3,6 3,7 2,8 3,10 3,10 1)),((6 4,6 5,5 4,4 4,5 5,5 6,4 6,4 7,4 8,5 9,4 9,4 10,6 10,7 9,8 8,8 7,7 7,7 8,6 8,5 8,5 7,6 7,6 6,7 5,7 4,6 4),(5.5 9.5,6 9,6 10,5.5 9.5)),((3 5,3 6,3.5 5.5,4 6,4 4,3 4,3 5)),((7 7,6 7,6 8,7 7)),((4 2,4 1,3 1,4 2)),((0 5,1 6,1 5,2 6,2 5,3 5,2 4,1 4,1 3,0 3,0 5)),((3 2,3 1,3 0,2 0,2 1,1 1,0 1,1 2,2 2,2 3,3 3,4 2,3 2)),((1 0,0 0,0 1,0.5 0.5,1 1,1 0)),((0 9,1 10,3 10,2 9,1 9,1 8,0 8,0 9)),((0 7,1 7,2 8,1 8,2 9,3 8,4 8,3 7,2 7,2 6,1 6,0 6,0 7)),((10 4,8 4,8 5,9 5,10 6,10 4)),((9 9,10 10,10 9,9 8,9 9)),((9 9,7 9,7 10,8 10,8.5 9.5,9 10,9 9)),((9 0,9 1,9.5 0.5,10 1,10 0,9 0)),((5 3,5 4,6 4,5 3)),((5 3,4 3,4 4,5 3)),((3 7,4 7,3 6,3 7)),((7 6,7 7,8 6,7 6)))",

    // Intersected with 0,4 (OK)
    "MULTIPOLYGON(((3 4,4 4,4 3,3 3,3 4)),((4 0,3 0,3 1,4 0)),((0 3,1 4,1 3,2 3,3 2,4 2,4 1,3 1,1 1,0 1,0 3),(1 2,0.5 1.5,1 1,1 2)),((3 3,2 3,2 4,3 3)))",
    "MULTIPOLYGON(((3 0,4 1,4 0,3 0)),((4 2,4 1,3 1,4 2)),((0 4,1 4,1 3,0 3,0 4)),((3 2,3 1,3 0,2 0,2 1,1 1,0 1,1 2,2 2,2 3,3 3,4 2,3 2)),((1 0,0 0,0 1,0.5 0.5,1 1,1 0)))",

    // Manually selected (problematic)
    "MULTIPOLYGON(((3 3,3 4,2 4,2 5,3 5,3 6,2 6,2 7,4 7,4 6,5 6,4.5 5.5,5 5,5 4,4 4,4 3,3 3)),((6 4,6 3,5 3,6 4)),((4 3,5 4,5 3,4 3)),((3 1,4 0,3 0,3 1)),((5 2,5 0,4 0,4 1,5 2)),((2 4,0 4,0 5,1 5,2 4)),((0 1,0 3,1 4,1 3,2 3,3 2,4 2,4 1,0 1),(1 1,1 2,0.5 1.5,1 1)),((2 4,3 3,2 3,2 4)))",
    "MULTIPOLYGON(((7 4,6 4,6 5,5 4,4 4,5 5,5 6,4 6,4 8,5 9,4 9,4 10,6 10,8 8,8 7,7 7,7 8,5 8,5 7,6 7,6 6,7 5,7 4)),((3 4,3 6,3.5 5.5,4 6,4 4,3 4)),((6 8,7 7,6 7,6 8)),((3 1,4 2,4 1,3 1)),((0 3,0 5,1 6,1 5,2 6,2 5,3 5,2 4,1 4,1 3,0 3)),((4 2,3 2,3 0,2 0,2 1,0 1,1 2,2 2,2 3,3 3,4 2)),((1 1,1 0,0 0,0 1,0.5 0.5,1 1)),((4 4,5 3,4 3,4 4)),((3 6,3 7,4 7,3 6)))"
};

static std::string case_recursive_boxes_92[2] =
{
    // Missing triangle in intersection upper-right. Requires different handling of cc
    "MULTIPOLYGON(((5 1,5 0,4 0,4 1,5 1)),((2 1,3 2,1 2,2 3,3 3,3 4,4 5,5 5,5 6,7 6,7 7,7.5 6.5,8 7,8 5,6 5,6 4,4 4,5 3,4 3,4 2,3 1,2 1)),((8 7,5 7,5 8,6 8,7 9,7 8,8 7)),((4 6,4 8,5 7,4 6)),((10 7,9 7,9 8,8 8,8 9,6 9,5 8,5 9,4 9,5 10,10 10,10 7)),((7 5,8 4,8 3,7 3,6 2,5 2,5 3,6 3,7 4,7 5)),((0 10,1 10,1 9,2 9,2 8,1 7,3 7,3 6,2 6,2 4,1 3,0 3,1 4,1 5,0 5,0 7,1 8,0 8,0 10)),((3 4,2 3,2 4,3 4)),((4 6,3 5,3 6,4 6)),((0 1,0 2,1 3,1 2,0.5 1.5,1 1,0 1)),((3 9,3 8,2 8,3 9)),((10 6,10 4,9 3,9 4,8 4,8 5,9 5,10 6)),((6 0,6 1,7 2,8 1,7 1,7 0,6 0)),((9 0,10 1,10 0,9 0)),((10 3,10 2,9 2,9 0,8 0,8 2,9 3,10 3)),((3 0,2 0,2 1,3 0)),((1 1,2 0,1 0,1 1)))",
    "MULTIPOLYGON(((4 7,5 6,4 6,4 7)),((10 10,9 9,10 8,10 7,6 7,5 6,5 7,4 7,5 8,6 8,6 9,5 9,5 10,7 10,8 9,8 10,10 10),(7 7,8 8,7 8,7 7),(10 8,9 8,9.5 7.5,10 8)),((6 6,5 5,5 6,6 6)),((6 4,5.5 3.5,6 3,5 2,4 2,5 3,5 4,6 4)),((3 0,3 2,4 2,4.5 1.5,5 2,5 1,4 1,5 0,3 0)),((3 7,3 9,3.5 8.5,4 9,5 9,3 7)),((10 3,9 2,9 3,7 3,6 2,6 5,7 6,10 6,10 5,9 5,9 4,10 4,10 3),(7 4,7 5,6.5 4.5,7 4),(8 4,8 5,7.5 4.5,8 4),(8 3,8 4,7 4,8 3)),((2 0,2 1,3 1,2 0)),((0 0,0 6,1 6,1.5 5.5,2 6,2 5,1 5,1 3,2 3,2 4,2.5 3.5,3 4,3 2,2 2,2 1,1 1,1 0,0 0)),((3 6,3 5,2 5,3 6)),((3 8,2.5 7.5,3 7,3 6,1 6,1 7,0 7,0 8,1 8,2 7,2 8,3 8)),((3 9,2 9,2 8,1 8,1 9,0 9,0 10,2 10,3 9)),((7 0,7 1,9 1,9 0,7 0)),((9 2,8 2,8 3,9 2)),((6 0,6 2,7 2,7 1,6 0)),((10 1,9 1,9 2,10 2,10 1)),((4 10,3 9,3 10,4 10)),((4 4,4 5,5 5,4 4)))"
};

static std::string case_recursive_boxes_93[2] =
{
    // Similar to 92
    "MULTIPOLYGON(((6 5,3 5,3 7,4 7,4 6,5 7,5 6,6 5)),((3 1,3 5,4 4,5 5,6 4,5 4,4 3,4 2,3 1)),((8 7,8 6,9 6,9 5,10 5,10 3,9 3,8 2,5 2,5 3,5.5 2.5,6 3,6 5,7 4,8 4,8 5,7 5,7 6,8 7),(7 3,6 3,6.5 2.5,7 3)),((4 1,4 2,5 2,5 1,4 1)),((3 0,3 1,4 1,3 0)),((10 1,9 0,5 0,6 1,6 2,6.5 1.5,7 2,7 1,10 1)),((9 10,9 8,8 8,9 7,7 7,7 6,6 6,6 7,5 7,6 8,6 10,7 9,7 10,9 10)),((4 7,5 8,5 7,4 7)),((4 8,4 10,5 10,5 8,4 8)),((3 10,2.5 9.5,3 9,3 7,2 6,2 5,1 5,1 6,2 7,2 8,1 8,1 9,2 9,2 10,3 10)),((2 4,1 4,1 5,2 4)),((0 9,1 9,0.5 8.5,1 8,1 6,0 6,0 9)),((3 3,2 3,2 4,3 3)),((0 1,0 5,1 4,1 3,2 3,2 2,1 1,0 1),(1 2,0 2,0.5 1.5,1 2)),((0 0,0 1,0.5 0.5,1 1,3 1,2 0,0 0)),((4 10,3 9,3 10,4 10)),((9 2,8 1,8 2,9 2)),((10 9,10 6,9 6,9 8,10 9)))",
    "MULTIPOLYGON(((2 2,2 3,4 5,4 3,3 3,2.5 2.5,3 2,2 2)),((10 10,10 9,9 8,8 8,8 7,7 7,7 5,4 5,4 8,3 8,3 7,1 7,1 8,2 9,0 9,0 10,3 10,3 9,5 9,5 8,6 9,6 8,7 9,8 9,9 10,9 9,10 10),(5 5,5 6,4.5 5.5,5 5),(6 8,5 7,6 7,6 8)),((7 10,7 9,5 9,5 10,7 10)),((4 9,4 10,5 10,4 9)),((9 5,9 4,8.5 3.5,9 3,10 3,10 1,8 1,8 0,4 0,5 1,5 2,6 3,6 4,7 4,7 3,6.5 2.5,7 2,8 3,8 5,9 5),(6 1,5 1,5.5 0.5,6 1),(7 1,6.5 0.5,7 0,7 1),(8 2,9 1,9 2,8 2)),((3 1,4 2,5 2,4.5 1.5,5 1,3 1)),((0 7,0.5 6.5,1 7,1 5,0 5,0 7)),((2 3,1 3,1 5,2 6,2 3)),((2 4,3 5,3 4,2 4)),((0 1,0 3,1 3,1 2,0 1)),((1 0,0 0,0 1,1 0)),((1 1,2 2,2 1,1 1)),((2 6,3 7,3 6,2 6)),((0 8,1 7,0 7,0 8)),((8 4,7 4,7 5,8 5,7.5 4.5,8 4)),((10 7,10 6,9 5,9 6,10 7)),((10 0,8 0,9 1,10 0)))"
};

static std::string case_recursive_boxes_94[2] =
{
    // Similar to 92, requires cc
    "MULTIPOLYGON(((6 5,5 5,5 9,7 9,7 10,8 9,7 8,6 8,6 5)),((1 8,1 10,5 10,5 9,4 8,4 7,3 7,3 8,1 8),(4 10,3.5 9.5,4 9,4 10),(3 8,3 9,2.5 8.5,3 8)),((1 5,1.5 4.5,2 5,3 5,4 6,3 6,4 7,5 6,4 5,4 4,5 4,5 3,3 3,3 4,1 4,1 5)),((3 1,3 2,4 2,4 3,5 2,5 3,6 4,6 3,6.5 2.5,7 3,7 2,6 2,5 1,3 1)),((2 0,2 1,3 1,2.5 0.5,3 0,2 0)),((3 0,4 1,4 0,3 0)),((1 3,2 4,2 3,1 3)),((0 0,0 1,2 1,1 0,0 0)),((3 2,2 1,2 2,3 2)),((0 4,1 4,1 3,0 3,0 4)),((3 7,3 6,1 6,2 7,3 7)),((0 6,0 7,1 8,1 6,0 6)),((0 9,1 8,0 8,0 9)),((0 9,0 10,1 10,0 9)),((8 4,7 4,7 5,8 4)),((6 4,6 5,7 6,7 5,6 4)),((9 6,9 5,8 5,8 6,8.5 5.5,9 6)),((9 4,8 3,8 4,9 4)),((9 8,9 6,6 6,8 8,9 8)),((10 7,10 6,9 6,10 7)),((6 0,7 1,7 2,8 2,8 3,10 3,10 2,9 2,8.5 1.5,9 1,9 0,6 0)),((5 0,6 1,6 0,5 0)),((10 2,10 1,9 1,10 2)),((10 4,9 3,9 4,10 4)),((8 10,10 10,10 8,9 8,9 9,8 9,8 10)),((9 7,10 8,10 7,9 7)))",
    "MULTIPOLYGON(((1 10,1 7,2 7,4 5,4 4,3 4,3 2,4 2,4 3,5 3,5 2,5.5 1.5,6 2,6 3,7 2,7 0,6 0,6 1,4 1,5 0,2 0,2 2,1 1,1 2,2 3,1 3,1 4,0 4,1 5,0 5,0 9,1 10),(2 6,3 5,3 6,2 6)),((2 7,2 9,3 9,3 8,4 8,4 9,5 8,6 8,5 7,4 7,4 6,3 6,3 7,2 7)),((8 3,6 3,6 5,5 5,5 7,7 7,7 6,8 5,7.5 4.5,8 4,8 3),(6 6,5 6,5.5 5.5,6 6),(7 6,6.5 5.5,7 5,7 6)),((6 4,5 4,5 5,6 4)),((0 2,0 3,1 3,1 2,0 2)),((0 0,1 1,1 0,0 0)),((3 10,2 9,2 10,3 10)),((10 3,9 3,9 6,8 6,8 7,9 8,9 7,10 8,10 3)),((8 4,8 6,9 5,8 4)),((9 3,9 2,7 2,8 3,9 3)),((10 0,8 0,8 1,9 2,9 1,10 1,10 0)),((7 7,7 9,9 9,8.5 8.5,9 8,8 8,8 7,7 7)),((10 10,10 8,9 8,9 9,10 10)),((5 10,5 9,3 9,4 10,5 10)))"
};

static std::string case_recursive_boxes_95[2] =
{
    // Similar to 92, requires cc
    "MULTIPOLYGON(((1 10,2 9,2 10,3 10,3 9,4 10,4 9,5 9,5 10,5.5 9.5,6 10,7 10,7 9,7.5 8.5,8 9,8 8,7 8,7 7,8 6,7 6,6.5 5.5,7 5,6 4,6 5,5 5,4 4,4 5,3 5,3 4,2 4,2 5,1 5,1 4,0 4,0 8,1 8,1 10),(4 9,3 8,3 7,4.5 5.5,5 6,5 7,4 7,5 8,4 8,4 9),(6 6,6 7,5 7,6 6),(3 6,2 6,2 5,3 6)),((4 7,5 6,4 6,4 7)),((4 4,6 4,5 3,6 3,7 2,6 2,5 1,5 2,4 2,4 4)),((3 3,4 2,3 2,3 3)),((8 2,8 0,4 0,4 1,6 1,6 2,7 1,7 2,8 2)),((8 4,8 3,6 3,6 4,8 4)),((3 1,4 0,3 0,3 1)),((1 3,1 4,2 4,2.5 3.5,3 4,3 3,1 3)),((0 2,0 3,1 3,0 2)),((0 2,1 2,1 0,0 0,0 2)),((9 9,10 9,10 4,9 3,8 3,9 4,8 4,8 6,9 7,9 9),(9 6,8 5,9 5,9 6)),((10 3,10 2,8 2,9 3,10 3)),((9 1,10 2,10 1,9 1)),((9 0,9 1,9.5 0.5,10 1,10 0,9 0)),((8 8,8 7,7 7,8 8)),((9 10,8 9,8 10,9 10)),((2 1,3 2,3 1,2 1)))",
    "MULTIPOLYGON(((10 5,9 4,8 4,7.5 3.5,8 3,8 2,7 2,7 3,6 2,3 2,4 3,4 4,3 3,3 4,4 5,3 5,4 6,4.5 5.5,5 6,6 6,6 4,7 5,7 6,8 5,9 6,9 5,10 5)),((8 0,4 0,4 1,5 2,6 1,6 2,7 2,7.5 1.5,8 2,8 0)),((9 10,9 9,8 9,8 8,7.5 7.5,8 7,7 6,7 7,6 6,6 7,5 7,5 8,4 8,4 10,5 10,5 9,5.5 8.5,7 10,9 10)),((0 1,0 4,1 5,1 6,2 5,2 6,3 7,4 7,4 8,5 7,4 6,3 6,2.5 5.5,3 5,3 4,2 4,2 3,1 3,2 2,1 2,0 1),(1 3,1 4,0.5 3.5,1 3)),((2 3,2.5 2.5,3 3,3 0,1 0,2 1,1 1,2 2,2 3)),((3 9,3 10,4 10,3 9)),((0 10,1 10,1 9,2 9,2 7,1 7,1 8,0 8,0 10)),((0 6,0 7,0.5 6.5,1 7,1 6,0 6)),((10 3,9 3,9 4,10 4,10 3)),((8 4,9 3,8 3,8 4)),((10 2,10 1,9.5 0.5,10 0,9 0,9 1,10 2)),((9 9,10 8,10 7,9 7,9 8,8 8,9 9)),((8 6,8 7,9 7,9 6,8 6)),((0 0,0 1,1 1,0 0)))"
};

static std::string case_recursive_boxes_96[2] =
{
    // Similar to 92, requires cc
    "MULTIPOLYGON(((8 4,8 3,7 3,6.5 2.5,7 2,5 2,7 4,8 4)),((10 0,5 0,5 2,5.5 1.5,6 2,6 1,7 1,7 2,8 3,8 1,9 1,10 0)),((6 6,6 5,5 5,6 6)),((9 10,9 9,8 9,9 8,9 7,10 7,10 6,8 6,8 5,7 4,5 4,4 3,4 4,3 4,3 3,2 3,2 5,1 5,1 4,0 4,0 5,1 6,0 6,0 8,1 8,1 7,3 9,3 10,9 10),(7 6,5 6,5 5,6 4,6 5,7 6),(2 7,3 7,3.5 6.5,4 7,4 6,6 8,6 9,4 9,4 8,2 8,2 7),(3 5,4 6,3 6,3 5),(8 8,8 9,7 9,7 8,8 8),(7 7,6 7,6.5 6.5,7 7),(2 6,1 6,1.5 5.5,2 6)),((5 3,6 4,6 3,5 3)),((4 8,5 8,5 7,4 7,4 8)),((3 8,4 7,3 7,3 8)),((3 1,3 3,3.5 2.5,4 3,4 1,3 1)),((0 2,0 3,1 4,2 3,1 3,1 2,0 2)),((0 1,1 2,2 2,1.5 1.5,2 1,2 0,1 0,1 1,0 1)),((3 2,2 1,2 2,3 2)),((1 9,2 9,2 8,1 8,1 9)),((0 10,1 9,0 9,0 10)),((10 5,9 5,9 6,10 5)),((9 4,9 3,8 3,9 4)),((10 4,10 1,9 1,9 2,8 2,10 4)),((10 9,10 8,9 8,10 9)))",
    "MULTIPOLYGON(((3 4,5 6,5.5 5.5,6 6,6 5,5 5,5 4,3 4)),((3 5,3 9,4 10,5 9,4 9,4 8,3.5 7.5,4 7,4 5,3 5)),((8 8,7 8,7 7,4 7,4 8,5 8,5 10,5.5 9.5,6 10,8 10,8 8),(6 8,6 9,5 9,6 8)),((6 7,6 6,5 6,6 7)),((0 3,1 3,1 4,2 4,2 5,3 5,3 4,4 3,5 3,5 2,4 1,3 1,3 2,0 2,0 3),(2 3,1 3,1.5 2.5,2 3),(4 3,3 3,3.5 2.5,4 3)),((7 3,7 2,6 2,6 3,7 3)),((7 1,6 1,6 2,7 1)),((5 1,5 2,6 2,5 1)),((7 0,5 0,5 1,6 1,7 0)),((0 6,0 9,1 8,2 8,2 9,3 8,2 7,1 7,1 6,0 6)),((0 5,1 4,0 4,0 5)),((1 1,2 1,2 0,1 0,1 1)),((3 1,3 0,2 0,3 1)),((3 9,1 9,1 10,2 10,3 9)),((7 7,8 7,8 4,7 3,7 4,6 4,6 5,7 6,7 7)),((7 1,7 2,8 2,9 3,8 3,9 4,8 4,9 5,10 5,10 2,9 2,9 1,7 1)),((9 7,10 6,9 5,9 7)),((7 0,8 1,8 0,7 0)),((5 4,6 4,6 3,5 3,5 4)),((9 0,9 1,10 2,10 0,9 0)),((10 10,10 7,8 7,8 8,9 8,9 10,10 10)))"
};

static std::string case_recursive_boxes_97[2] =
{
    "MULTIPOLYGON(((9 10,9 7,8 7,9 6,8 6,7 5,4 5,4 6,4.5 5.5,5 6,5 8,6 9,7 9,7 10,9 10),(8 8,7 8,7 7,8 7,8 8),(6 6,6 7,5 7,6 6)),((6 2,5 2,5 3,3 3,4 4,5 4,6 5,7 4,6 4,6 2)),((5 9,5 10,6 10,6 9,5 9)),((5 7,4 6,4 7,5 7)),((5 1,3 1,4 2,5 1)),((3 10,5 10,4 9,3 9,3 10)),((3 5,2 5,2 6,3 5)),((4 8,4 7,3 6,2 6,2 8,3 7,4 8)),((3 6,4 5,3 4,3 0,1 0,1 1,2 1,2 3,0 3,1 4,2 4,3 5,3 6)),((0 2,1 2,1 1,0.5 0.5,1 0,0 0,0 2)),((0 10,2 10,2 9,3 9,3 8,1 8,1 9,0 9,0 10)),((6 0,6 2,7 3,6 3,7 4,7 5,9 5,10 4,9 4,9 2,8 2,6 0),(8 3,7.5 2.5,8 2,8 3)),((9 7,10 7,10 5,9 5,9 7)),((7 0,7 1,8 1,7 0)),((9 2,9 1,8 1,9 2)),((0 4,1 5,1 4,0 4)),((0 7,1 7,1 5,0 5,0 7)))",
    "MULTIPOLYGON(((10 4,10 3,9 3,9 4,10 4)),((1 0,2 1,1 1,1 2,0 2,0 4,2 4,2 5,3 6,4 5,4 6,5 6,5 5,4.5 4.5,5 4,5 3,6 3,6.5 2.5,7 3,7 2,8 2,7 1,6 1,6 0,5 0,5 2,4 2,4 4,3 4,3 1,2 0,1 0),(2 2,3 3,2 3,2 2)),((4 1,5 0,4 0,4 1)),((10 10,10 9,9 8,8 8,8 9,7 9,7 8,6 8,5 7,5 8,4 7,4 9,5 10,5 9,5.5 8.5,6 9,6 10,10 10)),((10 8,10 7,9 6,8 6,9 5,8 4,7 4,7 6,5 6,5 7,6 7,6 8,7 7,8 7,8 8,9 7,10 8)),((2 6,3 7,3 6,2 6)),((0 6,1 7,0 7,0 9,1 10,3 10,3 8,4 7,2 7,2 6,0 6),(1 9,2 8,2 9,1 9),(1 9,0 8,1 8,1 9)),((10 5,9 5,9 6,10 6,10 5)),((9 2,8 1,8 2,9 2)),((9 1,9 2,10 2,10 1,9 1)),((5 7,4 6,4 7,5 7)),((0 1,1 0,0 0,0 1)),((6 5,6 4,5 4,6 5)),((10 0,9 0,9 1,10 0)))"
};

static std::string case_recursive_boxes_98[2] =
{
    // Needs skipping targets
    "MULTIPOLYGON(((1 8,1 9,2 8,1 8)),((2 6,2 7,2.5 6.5,4 8,5 7,6 6,5 6,5 5,4 4,4 5,3 5,2 5,1 5,2 6),(4 7,4 6,5 7,4 7)),((6 8,6 9,7 8,6 8)),((5 9,6 9,5 8,5 9)),((4 4,3 4,3 5,4 4)),((3 8,3 10,4 10,4 9,4 8,3 8)),((6 7,7 7,6 6,6 7)),((5 10,5 9,4 9,5 10)),((3 4,2 4,2 5,3 4)),((1 6,1 7,2 6,1 6)),((0 7,1 7,0 6,0 7)))",
    "MULTIPOLYGON(((4 7,5 7,4 6,4 7)),((6 7,5 7,6 8,6 7)),((6 4,5 4,6 5,6 4)),((5 4,4 4,4 5,5 5,5 4)),((7 8,6 8,2 8,2 9,7 9,7 8)),((1 5,2 5,2.5 4.5,3 5,3 4,2 4,1 4,1 5)),((1 6,1 7,2 6,1 6)),((1 8,1 7,0 7,0 8,1 8)),((3 5,2 5,3 6,3 5)),((7 5,6 5,6 6,7 5)))"
};

static std::string case_recursive_boxes_99[4] =
{
    // Has one ii turn with count right = 1 (it should be 2)
    // The smaller version ([2][3]) does not have this problem.
    "MULTIPOLYGON(((8 3,7 3,7 2,6 1,8 1,8 0,2 0,2 1,3 2,3 1,4 1,4 2,4.5 1.5,5 2,5 4,7 4,8 3),(5 3,6 2,6 3,5 3)),((8 10,8 9,6 9,6 8,3 8,3 10,6 10,6.5 9.5,7 10,8 10),(4 8,5 9,4 9,4 8)),((2 9,2 8,3 8,4 7,5 7,5 5,3 3,4 3,4 2,2 2,2 3,3 4,3 5,2 5,1 4,1 5,0 5,0 6,1 6,1 7,0 7,0 8,1 8,2 9),(5 6,4 6,4 5,5 6),(2 5,2 6,1.5 5.5,2 5),(2 6,3 7,2 7,2 6)),((1 0,0 0,0 2,0.5 1.5,1 2,1 0)),((2 4,2 3,1 2,0 2,0 4,1 4,1.5 3.5,2 4)),((0 8,0 10,2 10,2 9,1 9,0 8)),((9 4,10 5,10 4,9 4)),((7 6,7 5,6 5,6 6,7 6)),((10 7,10 6,9 6,9 5,7 5,8 6,7 6,7 7,8 7,8.5 6.5,9 7,10 7)),((9 1,9 3,10 3,10 2,9 1)),((8 1,8 3,9 2,8 1)),((7 1,7 2,8 2,7 1)),((6 7,6 8,7 9,7.5 8.5,8 9,9 8,7 8,6 7)),((10 9,9 9,9 10,10 10,10 9)),((5 6,6 7,6 6,5 6)),((8 8,9 7,8 7,8 8)),((2 5,3 4,2 4,2 5)))",
    "MULTIPOLYGON(((7 6,8 5,7 4,7 3,6 3,6 2,7 1,6 0,6 1,5 0,5 1,3 1,4 2,4 3,5 3,5 4,6 4,6 5,7 5,7 6)),((2 7,5 7,5 4,3 4,3 6,2 6,2 7)),((10 4,9 4,9 5,8 5,9 6,7 6,7 7,6 6,5 6,6 7,5 7,5 8,6 9,7 9,7 10,9 10,10 9,9 9,9 8,10 8,10 4),(7 7,8 8,7 8,7 7),(8 6,9 7,8 7,8 6)),((5 10,4 9,3 9,4 10,5 10)),((3 5,2.5 4.5,3 4,0 4,0 6,2 6,2 5,3 5),(0 5,0.5 4.5,1 5,0 5)),((3 0,2 0,2 1,3 1,2.5 0.5,3 0)),((2 3,1 3,1 4,2 3)),((2 0,0 0,0 1,1 1,2 0)),((0 2,1 3,1.5 2.5,2 3,2 2,0 2)),((3 9,2 8,0 8,1 9,3 9)),((3 10,2 9,2 10,3 10)),((10 2,8 2,9 3,10 3,10 2)),((8 4,9 3,8 3,8 4)),((9 1,10 2,10 1,9 1)),((9 0,7 0,7 2,8 2,8 1,8.5 0.5,9 1,9 0)),((6 9,5 9,5 10,6 10,6 9)),((1 6,1 7,2 7,1 6)),((8 5,9 4,8 4,8 5)),((3 3,4 2,3 2,3 3)),((2 3,3 4,3 3,2 3)),((1 1,2 2,2 1,1 1)))",
    "MULTIPOLYGON(((5 4,6 4,6 3,5 3,5 4)),((3 8,4 7,5 7,5 6,5 5,3 3,2 3,3 4,3 5,2 5,2 6,3 7,2 7,2 8,3 8),(4 6,4 5,5 6,4 6)),((6 7,6 6,5 6,6 7)),((3 4,2 4,2 5,3 4)))",
    "MULTIPOLYGON(((5 4,6 4,6 3,5 3,5 4)),((5 7,5 6,5 4,3 4,3 5,3 6,2 6,2 7,5 7)),((5 6,6 7,6 6,5 6)),((5 7,5 8,6 8,6 7,5 7)),((2.5 4.5,3 4,2 4,2 5,3 5,2.5 4.5)),((3 4,3 3,2 3,3 4)))"
};


static std::string case_bitset_1[2] =
{
...
static std::string case_bitset_2[3] =
{
    // (The last one is an invalid version of the first one)
    ...
    "MULTIPOLYGON(((6 2,6 0,0 0,0 2,2 2,2 4,4 4,4 2,6 2)),((10 2,10 0,8 0,8 2,10 2)),((14 4,14 2,12 2,12 4,14 4)))",
    "MULTIPOLYGON(((14 10,14 8,12 8,12 6,14 6,14 2,12 2,12 0,6 0,6 2,4 2,4 0,0 0,0 2,2 2,2 4,0 4,0 10,2 10,2 14,6 14,6 12,8 12,8 14,10 14,10 12,12 12,12 10,14 10),(12 10,8 10,8 8,8 6,4 6,4 4,6 4,6 2,8 2,8 4,10 4,10 8,12 8,12 10),(4 6,4 8,2 8,2 6,4 6),(4 8,6 8,6 10,4 10,4 8)),((14 12,12 12,12 14,14 14,14 12)))"
};

// Generates an extra interior ring, outside the main polygon.
// Must be caused by assign_parents - the generation itself is correct.
// It happens both in the traversal algorithm, and in the new traverse_through_graph algorithm.
static std::string case_bitset_3[2] =
{
    "MULTIPOLYGON(((4 0,4 2,8 2,10 2,10 0,4 0)),((0 2,0 4,2 4,2 2,0 2)),((10 4,8 4,8 6,6 6,6 8,4 8,4 10,8 10,10 10,10 4)))",
    "MULTIPOLYGON(((10 10,10 8,8 8,8 2,6 2,4 2,4 4,2 4,0 4,0 10,10 10),(4 8,2 8,2 6,4 6,4 8)))"
};
...
// To use intersection for difference research (made valid in tests)
static std::string issue_869_a_inverse[2] =
{
    "MULTIPOLYGON(((70 50,70 10,10 10,10 70,50 70,50 90,70 90,70 70,90 70,90 50,70 50)))",
    "MULTIPOLYGON(((0 0,0 100,100 100,100 0,0 0),(50 50,50 70,70 70,70 50,50 50),(50 50,50 30,30 30,30 50,50 50)))"
};
...
static std::string issue_1221[2] =
{
   "MULTIPOLYGON(((1 2,1 3,0 3,0 4,1 4,1 5,3 5,3 0,0 0,0 2,1 2),(1 2,1 1,2 1,2 2,1 2)))",
...
static std::string issue_1241[2] =
{
    "POLYGON((-124.19999999845255 51.901455507812500, -124.19999999460376 51.935823093966235, -123.99999999648789 51.935823093966235, -123.99999999317222 51.902564290309876, -124.19999999845255 51.901455507812500))",
    "POLYGON((-123.99999999367975 51.907655109375000, -123.99999999291659 51.900000006653443, -124.19999999861555 51.900000005468293, -124.19999999792353 51.906179355468751, -123.99999999367975 51.907655109375000))"
};
...
static std::string issue_1349[2] =
{
    "MULTIPOLYGON(((0 0,0 1178,2002 1178,2002 0,0 0),(1000.99879999999996 124.985299999999995,1011.01279999999997 134.999300000000005,1011.01400000000001 325.002599999999973,1001 335.016599999999983,990.98599999999999 325.002599999999973,990.98479999999995 134.999300000000005,1000.99879999999996 124.985299999999995)))",
    "MULTIPOLYGON(((1592.0101999999999407 1149.8399999999999181, 1586.9901999999999589 1149.8399999999999181, 1586.9901999999999589 1178.0000000000000000, 1592.0101999999999407 1178.0000000000000000, 1592.0101999999999407 1149.8399999999999181)), ((2001.9988000000000739 230.0014999999999930, 2001.9988000000000739 0.0015000000000000, 1000.9238000000000284 0.0000000000000000, 1000.9238000000000284 230.0765000000000100, 2001.9988000000000739 230.0014999999999930)))"
};

// To use intersection for difference research (made valid in tests)
static std::string issue_1349_inverse[2] =
{
    "MULTIPOLYGON(((0 0,0 1178,2002 1178,2002 0,0 0),(1000.99879999999996 124.985299999999995,1011.01279999999997 134.999300000000005,1011.01400000000001 325.002599999999973,1001 335.016599999999983,990.98599999999999 325.002599999999973,990.98479999999995 134.999300000000005,1000.99879999999996 124.985299999999995)))",
    "MULTIPOLYGON(((-1000 -1000,-1000 3000,3000 3000,3000 -1000,-1000 -1000),(1592.0101999999999407 1149.8399999999999181, 1586.9901999999999589 1149.8399999999999181, 1586.9901999999999589 1178.0000000000000000, 1592.0101999999999407 1178.0000000000000000, 1592.0101999999999407 1149.8399999999999181),(2001.9988000000000739 230.0014999999999930, 2001.9988000000000739 0.0015000000000000, 1000.9238000000000284 0.0000000000000000, 1000.9238000000000284 230.0765000000000100, 2001.9988000000000739 230.0014999999999930)))"
};

static std::string issue_1354[2] =
{
